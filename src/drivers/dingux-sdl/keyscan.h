...
#define DINGOO_A SDLK_K
#define DINGOO_B SDLK_J
#define DINGOO_X SDLK_I
#define DINGOO_Y SDLK_U
#define DINGOO_L SDLK_H
#define DINGOO_R SDLK_L
#define DINGOO_START SDLK_ENTER
#define DINGOO_SELECT SDLK_SPACE
#define DINGOO_MENU SDLK_ESCAPE
